...
### Upstream (laravel/sail)

* Use UTF-8 locale inside container (#849)
* Switch Yarn installation to Corepack in Dockerfiles (#846)
* Supports Laravel 13 (#847)
* Replace MariaDB vendor paths with published paths in compose file (#845)
